...
- Tests run: 282.
- Counts: passed=282, failed=0, error=0, skipped=0, expected_failure=0, unexpected_success=0.
...
| `discovery_and_core_model_contracts` | PASS | 10 | 10 | 0 | 0 | 0 | Validates stable core-model serialization, inclusion criteria, repository-aware recommendation rules, and mirage detection. |
...
| `statistical_and_review_safety` | PASS | 12 | 12 | 0 | 0 | 0 | Keeps uncertain mappings or annotations review-gated and validates effect-search multiplicity semantics. |
| `dataset_readiness_and_motrpac_alignment` | PASS | 7 | 7 | 0 | 0 | 0 | Validates deterministic dataset-readiness scoring and evidence-aware MoTrPAC metadata-alignment gates. |
| `motrpac_style_plotting` | PASS | 24 | 24 | 0 | 0 | 0 | Validates MoTrPAC contrast/FDR semantics, release and coverage gates, hierarchy views, deterministic exports, and optional renderers. |
...
| `benchmark_integrity_and_reproducibility` | PASS | 30 | 30 | 0 | 0 | 0 | Validates explicit benchmark denominators, independent-reference universe checks, CLI parity and isolation, provenance, and byte-reproducible pilot outputs. |
