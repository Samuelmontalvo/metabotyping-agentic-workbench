...
usage <- function() {
  cat(paste0(
    "Usage:\n",
    "  Rscript plot_rat_bag3_from_search_api.R --json rat_bag3_search_api_response.json --out-dir reports/motrpac_bag3\n\n",
    "Options:\n",
    "  --json       Saved MoTrPAC Data Hub gene-search JSON response.\n",
    "  --out-dir    Output directory. Default: reports/motrpac_bag3\n",
