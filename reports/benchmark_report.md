...
| quality_score_agreement_within_0.15 | 0.8 | 8 | 10 | applicable | [0.490162, 0.943318] |
...
| quality_score_agreement_within_0.15 | Gold quality-score studies with a prediction within an inclusive Decimal tolerance of 0.15, divided by all gold quality-score studies; missing predictions are failures. |  |


## Disagreements

| case_type | source_study | source_variable | reason_codes | gold | predicted | gold_review_status | predicted_review_status |
| --- | --- | --- | --- | --- | --- | --- | --- |
| quality | SYN-ANIMAL-MET |  | quality_score_outside_tolerance | 0.2 | 0.688 |  |  |
| quality | SYN-EXER-NODATA |  | quality_score_outside_tolerance | 0.33 | 0.484 |  |  |
...
| --- | --- | --- | --- | --- | --- |
| predicted_crosswalk | crosswalk.csv | present | 26 | source_study, source_variable, source_label, source_unit, source_timing, source_modality, proposed_common_variable, proposed_common_unit, transform, confidence, evidence, review_status | 41a4cc2840a2bc2fe5e931721d5917a32236591a257836abb0f8fae4c3eaab3a |
| predicted_quality_scores | quality_scores.json | present | 10 | activity_quality, body_composition_quality, cpet_quality, diet_quality, genetics_quality, harmonization_feasibility, metabolomics_quality, metadata_completeness, overall_score, rationale, study_design_rigor, study_id, temporal_alignment, weights | cb7bd2b24d813b09e9bc2db752d170b2b5b381e029af400efb7a2720f80ebb8f |
...
| gold_quality_scores | expert_quality_scores.csv | present | 10 | study_id, overall_score | fcc3c8e94432d16d25a359b4c86ad2b7f4c31c1546d7e841ec7b5f5896977c65 |
